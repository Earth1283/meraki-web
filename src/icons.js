const ICONS = {
  ...
  help: ['M12 21a9 9 0 1 0 0-18 9 9 0 0 0 0 18z', 'M9.6 9.2a2.5 2.5 0 1 1 3.4 2.3c-.6.3-1 .8-1 1.5v.5', 'M12 16.8h.01'],
  logout: ['M9 20H6a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h3', 'M16 16l4-4-4-4', 'M20 12H9'],
  close: ['M6 6l12 12', 'M18 6 6 18'],
  menu: ['M4 7h16', 'M4 12h16', 'M4 17h16'],
  more: ['M6 12h.01', 'M12 12h.01', 'M18 12h.01'],
  subject: ['M4 6h16', 'M12 6v12', 'M8 18h8'],
  back: ['M19 12H5', 'M11 18l-6-6 6-6'],
  download: ['M12 3v12', 'M7 10l5 5 5-5', 'M4 21h16'],
  book: ['M2 3h6a4 4 0 0 1 4 4v14a3 3 0 0 0-3-3H2z', 'M22 3h-6a4 4 0 0 0-4 4v14a3 3 0 0 1 3-3h7z'],
  quiz: ['M9 11.2a2.5 2.5 0 1 1 3.4 2.3c-.6.3-1 .8-1 1.5v.5', 'M12 17.8h.01', 'M4 5h16v15H4z'],
  dragHandle: [
